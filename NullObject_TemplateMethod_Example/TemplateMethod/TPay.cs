...
namespace TemplateMethod
{
    public class TPay : VanTemplate
    {
        protected override Response approval(DTOPayment dto)
        {
            ...
            MainWindow._instance.WriteTextbox(string.Format("TPay 단말기 결제 승인번호 : {0}", dto.AUTHNUM));
            return res;
        }
        ...
        {
            MainWindow._instance.WriteTextbox("TPay 단말기 연결 확인");
            return true;
        }
        ...
        protected override Response cancelApproval(DTOPayment dto)
        {
            ...
            MainWindow._instance.WriteTextbox(string.Format("TPay 단말기 결제 취소 원승인번호 : {0}, 취소승인번호 : {1}", dto.OLDAUTHNUM, dto.AUTHNUM));
            return res;
        }
    }
}
